...
**LingoLoot** is an engaging English learning application that combines education with gamification. Master new vocabulary, earn XP, maintain streaks, and collect exclusive NFT-style rewards to customize your profile! The Next.js app lives in `engquest-nextjs/`.
...
- **Story Cloze**: AI-generated story games to practice reading context.
- **Media Uploads**: Support for richer learning materials.
