      ...
      <div className="mx-auto w-full max-w-6xl px-4">
        <motion.div
          ...
          className={`mt-4 flex items-center justify-between rounded-full border px-4 py-3 transition duration-300 sm:px-6 ${
            isScrolled
              ? "border-white/60 bg-white/75 shadow-lg shadow-slate-200/70 backdrop-blur"
        ...
        >
          ...
          <button
            ...
            className="rounded-full bg-slate-900 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-slate-900/20 transition duration-300 hover:-translate-y-0.5 hover:bg-slate-800"
          >
            Bắt đầu ngay
          </button>
        </motion.div>
...
export default function HomePage() {
  ...
  return (
    <main
      className={`${manrope.variable} ${spaceGrotesk.variable} relative min-h-screen bg-gradient-to-br from-amber-50 via-white to-sky-50 font-[var(--font-body)] text-slate-900`}
    >
      ...
      >
        <div className="rounded-3xl border border-slate-200/70 bg-white/80 p-6 shadow-xl shadow-slate-200/60 backdrop-blur sm:p-8">
          <div className="max-w-2xl space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-amber-600">
              Vì sao LingoLoot?
            </p>
            <h2 className="font-[var(--font-display)] text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
          ...
          >
            <motion.div
              ...
              className="rounded-2xl border border-slate-200/70 bg-slate-50/80 p-6 text-slate-500"
            >
              <div className="flex items-start gap-4">
                <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-200/70 text-slate-600">
            ...
            <motion.div
              variants={cardVariants}
              className="relative overflow-hidden rounded-2xl border border-emerald-200/70 bg-gradient-to-br from-emerald-50 via-white to-amber-50 p-6 text-slate-700 shadow-2xl shadow-emerald-200/60"
            >
              <div className="pointer-events-none absolute -right-8 -top-8 h-28 w-28 rounded-full bg-emerald-200/70 blur-3xl" />
              <div className="flex items-start gap-4">
      ...
      >
        ...
        >
          <motion.div
            variants={cardVariants}
            className="relative overflow-hidden rounded-3xl border border-slate-200/70 bg-white/85 p-6 shadow-xl shadow-slate-200/60 md:col-span-2 lg:col-span-7 lg:row-span-3"
          >
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="rounded-2xl border border-emerald-200/70 bg-emerald-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-emerald-700">
                Live
              </div>
            </div>

            <div className="mt-6 space-y-4 rounded-2xl border border-slate-200/70 bg-slate-50/80 p-5">
              <p className="text-sm font-medium text-slate-600">
                Kéo thả từ vào khoảng trống để hoàn thành câu chuyện.
              </p>
              <div className="rounded-xl bg-white/90 p-4 shadow-inner shadow-slate-200/70">
                <p className="text-sm text-slate-600">
                  I went on an{" "}
                  <span className="inline-flex items-center rounded-full border border-dashed border-emerald-300/80 px-4 py-1 text-xs font-semibold text-emerald-600">
                    ___
                  </span>{" "}
                  to the mountains.
                </p>
          ...
          <motion.div
            variants={cardVariants}
            className="rounded-3xl border border-amber-200/70 bg-amber-50/80 p-6 shadow-lg shadow-amber-100/70 lg:col-span-5"
          >
            ...
            <div className="mt-6 flex items-center gap-3">
              <div className="rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-amber-600">
                Day 7
              </div>
              <div className="rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-amber-600">
                +10 XP
          ...
          <motion.div
            variants={cardVariants}
            className="rounded-3xl border border-sky-200/70 bg-sky-50/80 p-6 shadow-lg shadow-sky-100/70 lg:col-span-5"
          >
            <div className="flex items-center justify-between">
            ...
            <div className="mt-5 flex items-center gap-2 text-xs font-semibold text-sky-600">
              <span className="rounded-full bg-white/90 px-3 py-1">Quiz 1</span>
              <span className="rounded-full bg-white/90 px-3 py-1">Quiz 2</span>
              <span className="rounded-full bg-white/90 px-3 py-1">Quiz 3</span>
            </div>
          </motion.div>

          <motion.div
            variants={cardVariants}
            className="rounded-3xl border border-emerald-200/70 bg-emerald-50/80 p-6 shadow-lg shadow-emerald-100/70 lg:col-span-5"
          >
            <div className="flex items-center justify-between">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-emerald-600">
                Mastery Tracking
            ...
            <div className="mt-6">
              ...
              <div className="mt-2 h-2 w-full rounded-full bg-emerald-100">
                <div className="h-2 w-2/3 rounded-full bg-gradient-to-r from-emerald-500 to-amber-400" />
              </div>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          {testimonials.map((quote) => (
            <motion.div
              key={quote}
              variants={cardVariants}
              className="rounded-3xl border border-slate-200/70 bg-white/85 p-6 shadow-xl shadow-slate-200/60"
            >
      ...
      <motion.section
        ...
        variants={sectionVariants}
      >
        <div className="overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 to-blue-500 px-6 py-12 text-white shadow-2xl shadow-indigo-500/30 sm:px-10 sm:py-14">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-base font-semibold text-indigo-700 shadow-lg shadow-indigo-900/20 transition duration-300 hover:-translate-y-0.5 hover:bg-indigo-50 sm:px-8 sm:py-4 sm:text-lg"
            >
